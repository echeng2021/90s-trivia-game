    ...
    db.ref('scores').once('value')
        .then((snapshot) => {
            ...
            scoresArray.sort((a, b) => {
                ...
                return a.timestamp - b.timestamp; // Use timestamp for tie-breaker
            });
            ...
            leaderboardHTML += '<button id="return-to-start-btn" class="start-btn btn" style="margin-top: 20px;">Return to Start Screen</button>';
